...
class TestUserEdit(BaseCase):
    ...
    def test_edit_some_user_no_auth(self):
        user_id = 63453
        response1 = requests.get(f"https://playground.learnqa.ru/api/user/{user_id}")
    ...
    def test_edit_some_user_auth_another_user(self):
        ...
        response_get_user = requests.get(f"https://playground.learnqa.ru/api/user/{user_id_other_user}")
        ...
        response_get_other_user = requests.get(f"https://playground.learnqa.ru/api/user/{user_id_other_user}")
        response_get_auth_user = requests.get(f"https://playground.learnqa.ru/api/user/{user_id_from_auth_method}")
